...
<div class="absolute z-0 grid h-full w-full items-center gap-8 lg:grid-cols-2">
  <section
    class="absolute z-0 grid h-full w-full grid-cols-2 place-content-between"
  >
    <div class="{sharedClasses} -mx-[2.5px]"></div>
    <div class="{sharedClasses} -mx-[2px] place-self-end"></div>
    <div class="{sharedClasses} -mx-[2.5px]"></div>
    <div class="{sharedClasses} -mx-[2px] place-self-end"></div>
  </section>
</div>
